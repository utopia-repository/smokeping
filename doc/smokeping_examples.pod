...
=head2 Example 1: config.simple

=over

=item Probe configuration
...
=head2 Example 2: config.multiple-probes
...
=head2 Example 3: config.fping-instances
...
=head2 Example 4: config.targetvars-with-Curl
...
=head2 Example 5: config.echoping
...
=head2 Example 6: config.template
